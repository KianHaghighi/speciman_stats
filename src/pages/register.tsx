...
import { FiMail, FiLock, FiUser, FiDisc, FiEye, FiEyeOff } from 'react-icons/fi';
...
export default function RegisterPage() {
  ...
  const handleCredentialsRegister = async (data: RegisterForm) => {
    setIsLoading(true);
    try {
          ...
          {authMethod === 'discord' && (
            ...
            >
              ...
              >
                ...
                {isLoading ? 'Signing up...' : 'Continue with Discord'}
              </button>
              <p className="text-xs text-gray-500 dark:text-gray-400 text-center">
                Quick and secure registration with your Discord account
              </p>
            </motion.div>
          )}
